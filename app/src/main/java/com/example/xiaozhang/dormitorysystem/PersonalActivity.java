...
//        String uName = intent.getStringExtra("userName");
    ...
    void initView(){
        ...
        studentGender = findViewById(R.id.stugender);
        studentVcode = findViewById(R.id.stuvcode);
        studentRoom = findViewById(R.id.sturoom);
        studentBuilding = findViewById(R.id.stubuilding);
        studentLocation = findViewById(R.id.stulocation);
        studentGrade = findViewById(R.id.stugrade);
        searchDormitory = findViewById(R.id.search_dormitory);
    }
