...
public class DormitoryActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 初始化信息
    void initView(){
        button5 = findViewById(R.id.fifth_floor);
        button13 = findViewById(R.id.thirteenth_floor);
        button14 = findViewById(R.id.fourteenth_floor);
        button8 = findViewById(R.id.eighth_floor);
        button9 = findViewById(R.id.nineth_floor);
    }
